 ...
 */
class DockerComposeConfigProvider extends AbstractConfigProvider_1.AbstractConfigProvider {
    /**
     *
    ...
    addPropertiesToEnv(filepath) {
        try {
            const properties = fs_1.default.readFileSync(filepath, 'utf-8').split('\n');
    ...
    async getInstanceProviderUrl(instanceId, portType, resourceName) {
